...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("IncluirFornecedor",
        policy => policy.RequireClaim("IncluirFornecedor"));
    options.AddPolicy("UpdateFornecedor",
        policy => policy.RequireClaim("UpdateFornecedor"));
});
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "",
        Contact = new OpenApiContact { Name = "Getulio", Email = "" },
...
void MapActions(WebApplication app)
{
    ...
    .RequireAuthorization("UpdateFornecedor")
